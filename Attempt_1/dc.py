...
username = 'ShivtejGhatage'
password = 'Trading_123_View'
...
for symbol in nifty_symbols:
    symbol_data = tv.get_hist(symbol=symbol, exchange="NSE", interval=Interval.in_30_minute, n_bars=5000000)
...
df.dropna(inplace=True)
df.to_csv('newdata/Total_data.csv', index=False)
